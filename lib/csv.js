...
const TEMPLATE_ROWS = [
  { sku: "SKU-001", brand: "Natura Casa",   name: "Olivewood Coaster Set",       category: "Home · Dining",         marketplace: "Amazon India", our_price: 1299, competitor_name: "HomeKraft",   competitor_price: 1199, buy_box: "Lost", margin_floor: 1050, last_changed: "3 days ago", orders_in_period: 84,  period_days: 30, profit_margin: 19.2 },
  { sku: "SKU-001", brand: "Natura Casa",   name: "Olivewood Coaster Set",       category: "Home · Dining",         marketplace: "Amazon India", our_price: 1299, competitor_name: "UrbanLeaf",   competitor_price: 1249, buy_box: "Lost", margin_floor: 1050, last_changed: "3 days ago", orders_in_period: 84,  period_days: 30, profit_margin: 19.2 },
  { sku: "SKU-002", brand: "Natura Casa",   name: "Terracotta Planter, Medium",  category: "Garden · Decor",        marketplace: "Amazon India", our_price: 849,  competitor_name: "GreenNest",   competitor_price: 860,  buy_box: "Won",  margin_floor: 720,  last_changed: "Today",      orders_in_period: 156, period_days: 30, profit_margin: 15.2 },
  { sku: "SKU-003", brand: "LivSpace Pro",  name: "Modular Drawer System (3pc)", category: "Storage",               marketplace: "Amazon India", our_price: 2499, competitor_name: "ShelfMate",   competitor_price: 2199, buy_box: "Lost", margin_floor: 1800, last_changed: "6 days ago", orders_in_period: 42,  period_days: 30, profit_margin: 28.0 },
  { sku: "SKU-003", brand: "LivSpace Pro",  name: "Modular Drawer System (3pc)", category: "Storage",               marketplace: "Amazon India", our_price: 2499, competitor_name: "TidyHaus",    competitor_price: 2299, buy_box: "Lost", margin_floor: 1800, last_changed: "6 days ago", orders_in_period: 42,  period_days: 30, profit_margin: 28.0 },
  { sku: "SKU-003", brand: "LivSpace Pro",  name: "Modular Drawer System (3pc)", category: "Storage",               marketplace: "Amazon India", our_price: 2499, competitor_name: "PrimePicks",  competitor_price: 2389, buy_box: "Lost", margin_floor: 1800, last_changed: "6 days ago", orders_in_period: 42,  period_days: 30, profit_margin: 28.0 },
  { sku: "SKU-004", brand: "LivSpace Pro",  name: "Cable Sleeve, 1.5m",          category: "Storage · Accessories", marketplace: "Amazon India", our_price: 599,  competitor_name: "GadgetGrid",  competitor_price: 610,  buy_box: "Won",  margin_floor: 480,  last_changed: "2 days ago", orders_in_period: 312, period_days: 30, profit_margin: 19.9 },
  { sku: "SKU-005", brand: "Artisan Home",  name: "Hand-Hammered Brass Bowl",    category: "Home · Decor",          marketplace: "Amazon India", our_price: 3799, competitor_name: "Maison&Co",   competitor_price: 3750, buy_box: "Lost", margin_floor: 3200, last_changed: "1 day ago",  orders_in_period: 18,  period_days: 30, profit_margin: 15.8 },
  { sku: "SKU-006", brand: "Artisan Home",  name: "Walnut Tea Tray",             category: "Home · Dining",         marketplace: "Amazon India", our_price: 1150, competitor_name: "BrewCraft",   competitor_price: 1390, buy_box: "Won",  margin_floor: 900,  last_changed: "Today",      orders_in_period: 96,  period_days: 30, profit_margin: 21.7 },
  { sku: "SKU-007", brand: "Nordic Basics", name: "Linen Tea Towel, Pack of 2",  category: "Kitchen · Linen",       marketplace: "Amazon India", our_price: 449,  competitor_name: "LinenLab",    competitor_price: 399,  buy_box: "Lost", margin_floor: 420,  last_changed: "5 days ago", orders_in_period: 211, period_days: 30, profit_margin: 6.5 },
  { sku: "SKU-008", brand: "Nordic Basics", name: "Oak Cutting Board, Large",    category: "Kitchen · Boards",      marketplace: "Amazon India", our_price: 2199, competitor_name: "WoodWorks",   competitor_price: 2100, buy_box: "Lost", margin_floor: 1750, last_changed: "4 days ago", orders_in_period: 64,  period_days: 30, profit_margin: 20.4 }
];
...
const COLUMNS = [
  ...
  // Optional metrics from the category lead's own data — feed into the
  // AI prompt + forecast when present, ignored when blank.
  "orders_in_period", "period_days", "profit_margin"
];
...
const COL_ALIASES = {
  ...
  orders_in_period: ["orders_in_period", "orders", "order_count", "units_sold", "sales_units"],
  period_days: ["period_days", "period", "days_in_period", "window_days", "lookback_days"],
  profit_margin: ["profit_margin", "margin", "margin_pct", "profit_pct", "gross_margin"],
...
function ingestRows(records) {
  ...
  records.forEach((rawRow, idx) => {
    ...
    const ordersInPeriod = asNumber(pickField(r, "orders_in_period"));
    const periodDays = asNumber(pickField(r, "period_days"));
    // profit_margin accepts either a percent (e.g. 22.5) or a fraction
    // (0.225). We normalise to a 0–1 fraction internally.
    let profitMargin = asNumber(pickField(r, "profit_margin"));
    if (Number.isFinite(profitMargin) && profitMargin > 1) profitMargin = profitMargin / 100;
    ...
    out.push({
      ...
      ordersInPeriod: Number.isFinite(ordersInPeriod) ? ordersInPeriod : null,
      periodDays: Number.isFinite(periodDays) ? periodDays : null,
      profitMargin: Number.isFinite(profitMargin) ? profitMargin : null
    });
  });
...
function buildListingsFromIngested(rows) {
  ...
  for (const [key, group] of groups) {
    ...
    // Derived metric: orders/day from the period the lead reported.
    const ordersPerDay = head.ordersInPeriod != null && head.periodDays
      ? head.ordersInPeriod / head.periodDays
      : null;
    ...
    listings.push({
      ...
      // Real category-lead inputs — preserved as-is. Engine + AI both
      // prefer these over synthesized estimates when present.
      ordersInPeriod: head.ordersInPeriod,
      periodDays: head.periodDays,
      ordersPerDayInput: ordersPerDay,
      profitMargin: head.profitMargin,
      competitors,
